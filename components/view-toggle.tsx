...
export default function ViewToggle(){
    ...
    return(
        isSanityStudio? "":
        <div className={`fixed hover:underline decoration-dotted text-2xl py-1 left-0 bottom-0 m-5 z-20 flex cursor-pointer transition-all ${about==="open"? `blur-xl`: `${blurClass}`}`}>
            <button 
