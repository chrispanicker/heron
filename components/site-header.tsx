...
export function SiteHeader(){
    ...
    return (
        isSanityStudio? "" : <header className={`z-10 pointer-events-none vivaldii text-4xl p-12 lg:p-10 flex items-center justify-center fixed w-full ${selectedProject? "hidden lg:block": "block"}`}> 
