...
export function FilterButtons(filters:object){
    ...
    return(
    isSanityStudio? "" 
    : <div id="filters" className={`z-40 fixed top-[0dvh] font-bold transition-all duration-500 overflow-x-scroll w-screen justify-start flex text-[1.5rem]`} key={'parent'}>
