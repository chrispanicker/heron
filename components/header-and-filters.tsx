...
export function HeaderAndFilters({info, projects}:Props){
    ...
    return (
        <header className="flex-col sans justify-between items-center bg-black text-gray-300 lg:sticky fixed left-0 top-0 w-screen max-h-[2em] transition-all z-50 overflow-hidden">
            <SiteHeader />
