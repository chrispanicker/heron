...
export default function UsedFilters(){
    ...
    return( searchParams.toString().includes("collabs")|| searchParams.toString().includes("roles") || searchParams.toString().includes("tags")?
            <div className={`fixed flex flex-wrap w-screen leading-[1.1rem] bottom-6 text-lg z-30 justify-center text-center flex-row lg:text-xl px-5 pb-5 transition-all ${about==="open"? "blur-2xl": ""} ${selectedProject? "max-[1024px]:blur-2xl": ""}`}>
