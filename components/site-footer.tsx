    ...
    return (
        ...
        <footer ref={footerRef} className="text-lg w-full">
            <div id="footImgDiv" className={`flex w-screen top-screen justify-center items-center`}>
                <button id="footerTab" className={`fixed z-40 bottom-0 right-0 hover:bg-white hover:text-gray-400 decoration-dotted m-5 text-[1rem] leading-[1.4rem] px-1 py-0 w-fit whitespace-nowrap ${project && view==="all"? "blur-2xl" : `${blurClass}`}`} onClick={()=>{
            ...
            <span id="footer" className={`z-30 fixed lg:flex lg:flex-col bottom-0 h-[0vh] duration-500 transition-all overflow-y-scroll lg:mx-40  ${about==="open"? "h-[100vh]  lg:py-20": "h-[0vh]"}`}>
