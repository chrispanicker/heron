    ...
    return (
        ...
        <footer ref={footerRef} className="w-full">
            <div id="footImgDiv" className={`flex w-screen top-screen justify-center items-center`}>
                <button id="footerTab" className={`fixed z-[31] bottom-0 right-0 hover:bg-white hover:text-gray-400 decoration-dotted lg:mx-40 mx-5 mb-5 leading-[1.4rem] px-1 py-0 w-fit whitespace-nowrap  ${project? `blur-xl`: `${blurClass}`}`} onClick={()=>{
            ...
            <span id="footer" className={`fixed z-30 lg:flex lg:flex-col bottom-0 h-[0vh] duration-500 transition-all lg:px-40 lg:pt-40 px-5 lg:overflow-y-hidden overflow-x-hiddenoverflow-y-scroll  ${about==="open"? " pb-20 h-[100vh] blur-auto backdrop-blur-3xl backdrop-brightness-[.7]": "blur-3xl h-[0vh]"}`}>
