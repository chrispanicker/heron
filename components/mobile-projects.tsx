...
export default function MobileProjects({ project, isActive, onInView }: Props) {
    ...
    return isSanityStudio? "": (
        <div ref={projRef} id={`mobile-${project.slug}`} className="snap-start snap-always relative min-h-[100vh] h-[100vh] lg:hidden block relative items-end mx-2 last:mb-64">
            ...
            <span className="duration-500 z-0">
              <MobileGallery project={project} onImageChange={handleGalleryScroll} isActive={isActive} />
            </span>
