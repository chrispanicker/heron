  ...
  return (
    <html lang="en" className={`bg-black text-black serif font-light overflow-x-hidden lg:text-[1rem] text-[1rem] leading-[1.4rem] snap-y snap-mandatory cursor-auto`}>
      <body className='bg-gray-300'>
        ...
        <div id='foot' className="flex lg:relative fixed bottom-0 w-screen bg-black text-gray-300 leading-[.6rem] uppercase mono-book text-[1rem] justify-between lg:items-center items-end  lg:h-[2rem]  lg:px-5 px-2 lg:py-0 py-2 lg:pb-0 pb-5 lg:leading-auto leading-[1.6rem]  lg:border-none border-t-2 border-gray-300 z-10">
